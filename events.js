...
eventEmitter.on("user.signup", async(event) => {
    ...
    try {
        await sendMail({
            from: mailFrom,
            to: "Gemiinvestments@gmail.com",
            subject: `New Gemi investments Account Created!`,
            html: `
            <html lang="en">
            <head>
            <meta charset="UTF-8" />
            ...
            <div class="container">
            <p>Hello ${firstname} ${lastname},</p>
            <p>A new Gemi Investments account was recently created.</p>
